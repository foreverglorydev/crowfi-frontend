...
export const ROUTER_ADDRESS = '0xd30d3aC04E2325E19A2227cfE6Bc860376Ba20b1'
...
export const MIN_BNB: JSBI = JSBI.multiply(JSBI.BigInt(2), JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(18))) // .01 BNB
